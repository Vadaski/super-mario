...
export class AudioEngine {
  ...
  // -----------------------------------------------------------------------
  // Original composition: upbeat G major adventure melody, ~160 BPM.
  ...
  private static readonly overworldMelody: [string, number][] = [
    ...
    ['G4', 0.5], ['A4', 0.25], ['B4', 0.25], ['D5', 0.5], ['B4', 0.25], ['A4', 0.25],
    ['G4', 0.5], ['_', 0.25], ['D4', 0.25], ['G4', 0.5], ['_', 0.5],
    // Bar 2 – ascending answer
    ['A4', 0.25], ['B4', 0.25], ['C5', 0.5], ['D5', 0.5], ['E5', 0.5],
    ['D5', 0.25], ['C5', 0.25], ['B4', 0.5], ['_', 0.5],
    // Bar 3 – playful bounce
    ['E5', 0.25], ['_', 0.25], ['E5', 0.25], ['D5', 0.25],
    ['C5', 0.5], ['A4', 0.5], ['B4', 0.5], ['G4', 0.5], ['_', 0.5],
    // Bar 4 – resolution with syncopation
    ['D5', 0.25], ['C5', 0.25], ['B4', 0.5], ['A4', 0.25], ['_', 0.25],
    ['G4', 0.5], ['A4', 0.25], ['B4', 0.25], ['G4', 0.75], ['_', 0.25],
    // Bar 5 – second phrase, higher register
    ['B4', 0.5], ['D5', 0.25], ['E5', 0.25], ['G5', 0.5], ['E5', 0.25], ['D5', 0.25],
    ['B4', 0.5], ['_', 0.25], ['G4', 0.25], ['B4', 0.5], ['_', 0.5],
    // Bar 6 – descending scale run
    ['G5', 0.25], ['F#5', 0.25], ['E5', 0.25], ['D5', 0.25],
    ['C5', 0.25], ['B4', 0.25], ['A4', 0.25], ['G4', 0.25],
    ['A4', 0.5], ['B4', 0.5], ['_', 0.5],
    // Bar 7 – call and response
    ['D5', 0.5], ['_', 0.25], ['D5', 0.25], ['E5', 0.5], ['_', 0.25], ['E5', 0.25],
    ['D5', 0.25], ['C5', 0.25], ['B4', 0.25], ['A4', 0.25], ['G4', 0.5], ['_', 0.5],
    // Bar 8 – rhythmic hook
    ['B4', 0.25], ['_', 0.25], ['B4', 0.25], ['_', 0.25],
    ['D5', 0.25], ['_', 0.25], ['D5', 0.25], ['_', 0.25],
    ['G5', 0.5], ['D5', 0.5], ['B4', 0.5], ['_', 0.5],
    // Bar 9 – variation on bar 1
    ['G4', 0.5], ['B4', 0.25], ['D5', 0.25], ['G5', 0.5], ['D5', 0.25], ['B4', 0.25],
    ['A4', 0.5], ['_', 0.25], ['E4', 0.25], ['A4', 0.5], ['_', 0.5],
    // Bar 10 – bridge melody
    ['C5', 0.5], ['D5', 0.25], ['E5', 0.25], ['F#5', 0.5], ['E5', 0.5],
    ['D5', 0.25], ['C5', 0.25], ['B4', 0.5], ['_', 0.5],
    // Bar 11 – syncopated groove
    ['E5', 0.25], ['_', 0.25], ['D5', 0.5], ['_', 0.25], ['C5', 0.25],
    ['B4', 0.5], ['A4', 0.25], ['_', 0.25], ['G4', 0.5], ['_', 0.5],
    // Bar 12 – ascending arpeggio burst
    ['G4', 0.25], ['B4', 0.25], ['D5', 0.25], ['G5', 0.25],
    ['A5', 0.5], ['G5', 0.25], ['E5', 0.25], ['D5', 0.5], ['_', 0.5],
    // Bar 13 – echo of bar 5
    ['B4', 0.5], ['D5', 0.25], ['G5', 0.25], ['A5', 0.5], ['G5', 0.25], ['E5', 0.25],
    ['D5', 0.5], ['_', 0.25], ['B4', 0.25], ['D5', 0.5], ['_', 0.5],
    // Bar 14 – walking down
    ['E5', 0.5], ['D5', 0.5], ['C5', 0.5], ['B4', 0.5],
    ['A4', 0.5], ['G4', 0.5], ['_', 1],
    // Bar 15 – triumphant peak
    ['G5', 0.5], ['_', 0.25], ['G5', 0.25], ['A5', 0.5], ['G5', 0.5],
    ['E5', 0.5], ['D5', 0.25], ['B4', 0.25], ['G4', 0.5], ['_', 0.5],
    // Bar 16 – resolving cadence
  ...
  private static readonly overworldBass: [string, number][] = [
    // Bar 1
    ['G2', 0.5], ['_', 0.5], ['G3', 0.5], ['_', 0.5],
    ['G2', 0.5], ['_', 0.5], ['D3', 0.5], ['_', 0.5],
    // Bar 2
    ['C3', 0.5], ['_', 0.5], ['E3', 0.5], ['_', 0.5],
    ['G3', 0.5], ['_', 0.5], ['D3', 0.5], ['_', 0.5],
    // Bar 3
    ['C3', 0.5], ['_', 0.5], ['C3', 0.5], ['_', 0.5],
    ['D3', 0.5], ['_', 0.5], ['G2', 0.5], ['_', 0.5],
    // Bar 4
    ['D3', 0.5], ['_', 0.5], ['C3', 0.5], ['_', 0.5],
    ['G2', 0.5], ['D3', 0.5], ['G2', 0.75], ['_', 0.25],
    // Bar 5
    ['G2', 0.5], ['_', 0.5], ['B2', 0.5], ['_', 0.5],
    ['D3', 0.5], ['_', 0.5], ['G3', 0.5], ['_', 0.5],
    // Bar 6
    ['E3', 0.5], ['_', 0.5], ['D3', 0.5], ['_', 0.5],
    ['C3', 0.5], ['_', 0.5], ['G2', 0.5], ['_', 0.5],
    // Bar 7
    ['D3', 0.5], ['_', 0.5], ['D3', 0.5], ['_', 0.5],
    ['C3', 0.5], ['D3', 0.5], ['G2', 0.5], ['_', 0.5],
    // Bar 8
    ['G2', 0.5], ['B2', 0.5], ['D3', 0.5], ['B2', 0.5],
    ['G3', 0.5], ['D3', 0.5], ['G2', 0.5], ['_', 0.5],
    // Bar 9
    ['G2', 0.5], ['_', 0.5], ['B2', 0.5], ['_', 0.5],
    ['A2', 0.5], ['_', 0.5], ['E3', 0.5], ['_', 0.5],
    // Bar 10
    ['A2', 0.5], ['_', 0.5], ['C3', 0.5], ['_', 0.5],
    ['D3', 0.5], ['_', 0.5], ['G2', 0.5], ['_', 0.5],
    // Bar 11
    ['C3', 0.5], ['_', 0.5], ['D3', 0.5], ['_', 0.5],
    ['E3', 0.5], ['_', 0.5], ['G2', 0.5], ['_', 0.5],
    // Bar 12
    ['G2', 0.5], ['B2', 0.5], ['D3', 0.5], ['G3', 0.5],
    ['C3', 0.5], ['_', 0.5], ['D3', 0.5], ['_', 0.5],
    // Bar 13
    ['G2', 0.5], ['_', 0.5], ['B2', 0.5], ['_', 0.5],
    ['D3', 0.5], ['_', 0.5], ['G3', 0.5], ['_', 0.5],
    // Bar 14
    ['C3', 0.5], ['D3', 0.5], ['E3', 0.5], ['D3', 0.5],
    ['C3', 0.5], ['G2', 0.5], ['_', 1],
    // Bar 15
    ['E3', 0.5], ['_', 0.5], ['E3', 0.5], ['_', 0.5],
    ['C3', 0.5], ['D3', 0.5], ['G2', 0.5], ['_', 0.5],
    // Bar 16
    ['C3', 0.5], ['D3', 0.5], ['E3', 0.5], ['D3', 0.5],
    ['G2', 1], ['_', 1],
  ...
  // -----------------------------------------------------------------------
  // Star Theme (invincibility) — original composition
  // -----------------------------------------------------------------------

  private static readonly starMelody: [string, number][] = [
    // Original composition: frantic D major rush, 8 bars, tight loop
    // Bar 1 – rapid ascending bursts
    ['D5', 0.25], ['F#5', 0.25], ['A5', 0.25], ['D6', 0.25],
    ['A5', 0.25], ['F#5', 0.25], ['A5', 0.25], ['D6', 0.25],
    // Bar 2 – leap and bounce
    ['E5', 0.25], ['G5', 0.25], ['B5', 0.25], ['E6', 0.25],
    ['B5', 0.25], ['G5', 0.25], ['B5', 0.25], ['E6', 0.25],
    // Bar 3 – driving forward
    ['F#5', 0.25], ['A5', 0.25], ['D6', 0.25], ['F#6', 0.25],
    ['D6', 0.25], ['A5', 0.25], ['F#5', 0.25], ['A5', 0.25],
    // Bar 4 – descending fire
    ['G5', 0.25], ['E5', 0.25], ['D5', 0.25], ['B4', 0.25],
    ['A4', 0.25], ['D5', 0.25], ['F#5', 0.25], ['A5', 0.25],
    // Bar 5 – second half intensity
    ['B5', 0.25], ['A5', 0.25], ['G5', 0.25], ['A5', 0.25],
    ['B5', 0.25], ['D6', 0.25], ['B5', 0.25], ['A5', 0.25],
    // Bar 6 – staccato hits
    ['G5', 0.25], ['_', 0.25], ['G5', 0.25], ['_', 0.25],
    ['A5', 0.25], ['_', 0.25], ['B5', 0.25], ['_', 0.25],
    // Bar 7 – climax phrase
    ['D6', 0.25], ['B5', 0.25], ['A5', 0.25], ['G5', 0.25],
    ['F#5', 0.25], ['A5', 0.25], ['D6', 0.25], ['F#6', 0.25],
    // Bar 8 – turnaround
    ['E6', 0.25], ['D6', 0.25], ['B5', 0.25], ['A5', 0.25],
    ['G5', 0.25], ['F#5', 0.25], ['D5', 0.25], ['_', 0.25],
  ];
  ...
  private static readonly starBass: [string, number][] = [
    ...
    ['E3', 0.5], ['B3', 0.5], ['E3', 0.5], ['B3', 0.5],
    ['D3', 0.5], ['A3', 0.5], ['F#3', 0.5], ['A3', 0.5],
    ['D3', 0.5], ['A3', 0.5], ['D3', 0.5], ['A3', 0.5],
    ['G3', 0.5], ['D3', 0.5], ['A2', 0.5], ['D3', 0.5],
    ['G2', 0.5], ['A2', 0.5], ['D3', 0.5], ['A2', 0.5],
    ['G2', 0.5], ['D3', 0.5], ['G2', 0.5], ['D3', 0.5],
    ['E3', 0.5], ['B2', 0.5], ['E3', 0.5], ['B2', 0.5],
    ['G2', 0.5], ['_', 0.25], ['G2', 0.25], ['A2', 0.5], ['_', 0.25], ['A2', 0.25],
    ['B2', 0.5], ['_', 0.25], ['B2', 0.25], ['A2', 0.5], ['_', 0.25], ['A2', 0.25],
    ['D3', 0.5], ['A3', 0.5], ['D3', 0.5], ['A3', 0.5],
    ['D3', 0.5], ['A3', 0.5], ['D3', 0.5], ['A3', 0.5],
    ['G2', 0.5], ['D3', 0.5], ['A2', 0.5], ['D3', 0.5],
    ['G2', 0.5], ['A2', 0.5], ['D3', 0.5], ['_', 0.5],
  ];
  ...
  playStarTheme(): void {
    ...
    const play = () => {
      ...
      const ctx = this.ctx;
      const t = ctx.currentTime + 0.05;
      const bpm = 240; // Fast tempo for star power
  ...
  private static readonly undergroundMelody: [string, number][] = [
    // Original composition: mysterious E minor, staccato and sparse
    // Bar 1 – creeping motif
    ['E4', 0.25], ['_', 0.25], ['E4', 0.25], ['_', 0.25],
    ['D4', 0.25], ['_', 0.25], ['E4', 0.5], ['_', 0.5],
    // Bar 2 – answer phrase
    ['G4', 0.25], ['_', 0.25], ['F#4', 0.25], ['_', 0.25],
    ['E4', 0.25], ['_', 0.5], ['B3', 0.5], ['_', 0.25],
    // Bar 3 – descending tension
    ['D4', 0.25], ['_', 0.25], ['C4', 0.25], ['_', 0.25],
    ['B3', 0.25], ['_', 0.25], ['A3', 0.5], ['_', 0.5],
    // Bar 4 – chromatic creep up
    ['A3', 0.25], ['A#3', 0.25], ['B3', 0.25], ['_', 0.25],
    ['C4', 0.25], ['_', 0.25], ['B3', 0.25], ['_', 0.75],
    // Bar 5 – echo of bar 1 with variation
    ['E4', 0.25], ['_', 0.25], ['G4', 0.25], ['_', 0.25],
    ['F#4', 0.25], ['_', 0.25], ['E4', 0.5], ['_', 0.5],
    // Bar 6 – haunting leap
    ['B4', 0.5], ['_', 0.25], ['A4', 0.25], ['G4', 0.25], ['_', 0.25],
    ['E4', 0.25], ['_', 0.25], ['D4', 0.5],
    // Bar 7 – rhythmic stabs
    ['E4', 0.25], ['_', 0.5], ['E4', 0.25], ['_', 0.5],
    ['D4', 0.25], ['_', 0.5], ['C4', 0.25], ['_', 0.5],
    // Bar 8 – low resolve
    ['B3', 0.25], ['_', 0.25], ['A3', 0.25], ['_', 0.25],
    ['G3', 0.25], ['_', 0.25], ['E3', 0.5], ['_', 0.75],
    // Bar 9 – second pass darker
    ['E4', 0.25], ['_', 0.5], ['D#4', 0.25], ['_', 0.5],
    ['D4', 0.25], ['_', 0.25], ['C4', 0.5], ['_', 0.5],
    // Bar 10 – sparse hits
    ['B3', 0.5], ['_', 0.5], ['G3', 0.5], ['_', 0.5],
    ['A3', 0.25], ['_', 0.25], ['B3', 0.5], ['_', 0.5],
  ];

  private static readonly undergroundBass: [string, number][] = [
    // Heavy low octave pulse in E minor
    ['E2', 0.5], ['E3', 0.5], ['E2', 0.5], ['E3', 0.5],
    ['E2', 0.5], ['E3', 0.5], ['E2', 0.5], ['E3', 0.5],
    ['D2', 0.5], ['D3', 0.5], ['D2', 0.5], ['D3', 0.5],
    ['A1', 0.5], ['A2', 0.5], ['A1', 0.5], ['A2', 0.5],
    ['A1', 0.5], ['A2', 0.5], ['B1', 0.5], ['B2', 0.5],
    ['C2', 0.5], ['C3', 0.5], ['B1', 0.5], ['B2', 0.5],
    ['E2', 0.5], ['E3', 0.5], ['E2', 0.5], ['E3', 0.5],
    ['G2', 0.5], ['G3', 0.5], ['E2', 0.5], ['E3', 0.5],
    ['B1', 0.5], ['B2', 0.5], ['E2', 0.5], ['E3', 0.5],
    ['A1', 0.5], ['A2', 0.5], ['G1', 0.5], ['G2', 0.5],
    ['E2', 0.5], ['B2', 0.5], ['E2', 0.5], ['B2', 0.5],
    ['D2', 0.5], ['A2', 0.5], ['D2', 0.5], ['A2', 0.5],
    ['E2', 0.5], ['E3', 0.5], ['D2', 0.5], ['D3', 0.5],
    ['C2', 0.5], ['G2', 0.5], ['B1', 0.5], ['E2', 0.5],
    ['E2', 0.5], ['B2', 0.5], ['E2', 0.5], ['B2', 0.5],
    ['A1', 0.5], ['E2', 0.5], ['B1', 0.5], ['E2', 0.5],
  ];
  ...
  private static readonly castleMelody: [string, number][] = [
    // Original composition: ominous D minor with chromatic tension, 10 bars
    // Bar 1 – slow menacing descent
    ['D4', 0.75], ['_', 0.25], ['C#4', 0.75], ['_', 0.25],
    ['C4', 0.75], ['_', 0.25], ['B3', 0.75], ['_', 0.25],
    // Bar 2 – chromatic crawl
    ['A#3', 0.75], ['_', 0.25], ['A3', 0.5], ['_', 0.5],
    ['A3', 0.25], ['A#3', 0.25], ['A3', 0.25], ['G#3', 0.25], ['_', 0.5],
    // Bar 3 – stabbing chords
    ['D4', 0.5], ['_', 0.5], ['F4', 0.5], ['_', 0.5],
    ['D4', 0.5], ['_', 0.25], ['C4', 0.25], ['A3', 0.5], ['_', 0.5],
    // Bar 4 – low rumble phrase
    ['A3', 0.25], ['_', 0.25], ['D4', 0.25], ['_', 0.25],
    ['F4', 0.25], ['E4', 0.25], ['D4', 0.25], ['_', 0.25],
    ['C#4', 0.5], ['_', 0.5],
    // Bar 5 – eerie high notes
    ['A4', 0.75], ['_', 0.25], ['G#4', 0.75], ['_', 0.25],
    ['G4', 0.75], ['_', 0.25], ['F4', 0.75], ['_', 0.25],
    // Bar 6 – chromatic descent continuation
    ['E4', 0.5], ['_', 0.5], ['D#4', 0.5], ['_', 0.5],
    ['D4', 0.5], ['_', 0.25], ['A3', 0.25], ['_', 0.5],
    // Bar 7 – rhythmic dread
    ['D4', 0.25], ['_', 0.25], ['D4', 0.25], ['_', 0.5],
    ['F4', 0.25], ['_', 0.25], ['F4', 0.25], ['_', 0.5],
    ['E4', 0.25], ['_', 0.25], ['D4', 0.25], ['_', 0.25],
    // Bar 8 – final menace
    ['C#4', 0.25], ['D4', 0.25], ['E4', 0.25], ['D4', 0.25],
    ['A3', 0.5], ['_', 0.5], ['D4', 0.75], ['_', 0.25],
  ];

  private static readonly castleBass: [string, number][] = [
    // Ominous low octave pulses in D minor
    ['D2', 0.5], ['D3', 0.5], ['D2', 0.5], ['D3', 0.5],
    ['C#2', 0.5], ['C#3', 0.5], ['C2', 0.5], ['C3', 0.5],
    ['A#1', 0.5], ['A#2', 0.5], ['A1', 0.5], ['A2', 0.5],
    ['A1', 0.5], ['A2', 0.5], ['G#1', 0.5], ['G#2', 0.5],
    ['D2', 0.5], ['A2', 0.5], ['D2', 0.5], ['F2', 0.5],
    ['D2', 0.5], ['A2', 0.5], ['A1', 0.5], ['A2', 0.5],
    ['A1', 0.5], ['D2', 0.5], ['F2', 0.5], ['E2', 0.5],
    ['D2', 0.5], ['C#2', 0.5], ['D2', 0.5], ['A1', 0.5],
    ['D2', 0.5], ['D3', 0.5], ['D2', 0.5], ['D3', 0.5],
    ['C#2', 0.5], ['C#3', 0.5], ['C2', 0.5], ['C3', 0.5],
    ['E2', 0.5], ['E3', 0.5], ['D#2', 0.5], ['D#3', 0.5],
    ['D2', 0.5], ['D3', 0.5], ['A1', 0.5], ['A2', 0.5],
    ['D2', 0.5], ['D3', 0.5], ['F2', 0.5], ['F3', 0.5],
    ['E2', 0.5], ['E3', 0.5], ['D2', 0.5], ['D3', 0.5],
    ['C#2', 0.5], ['D2', 0.5], ['E2', 0.5], ['D2', 0.5],
    ['A1', 0.5], ['A2', 0.5], ['D2', 0.75], ['_', 0.25],
  ];
